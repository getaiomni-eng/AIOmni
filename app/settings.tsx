...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontFamily: 'DMMono-Regular', color: '#333', fontSize: 9, letterSpacing: 2, marginBottom: 8 },
  ...
  rowLabel: { fontFamily: 'Outfit', color: '#666', fontSize: 14 },
  rowValue: { fontFamily: 'Outfit-SemiBold', color: '#fff', fontSize: 14 },
  ...
  signOutText: { fontFamily: 'Outfit-Bold', color: '#ff2255', fontSize: 16, letterSpacing: 3 },
  tagline: { fontFamily: 'DMMono-Regular', color: '#1a1a2e', fontSize: 10, textAlign: 'center', letterSpacing: 1 },
});
